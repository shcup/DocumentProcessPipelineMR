...
public class ClassificationTrainingDataMatchMRnew {
...
//	    	String label = prefixMatch.GetMatchedPatternLabel(compositeDoc.doc_url);
	    	...
	    	String label = compositeDoc.media_doc_info.normalized_category_info.category_item.get(0).category_path.get(0);
    ...
    public static void main(String[] args) throws Exception
    {
    	...
    	job.setJarByClass(ClassificationTrainingDataMatchMRnew.class);
